...
public class Wheel_Actuator extends Subsystem {
    ...
    double m_motor_power;
    
    // Put methods for controlling this subsystem
    // here. Call these from Commands.
    public void run_Wheel_Actuator(double motor_power){
        m_motor_power=motor_power;
        wheelActuatorMotor.set(m_motor_power);    
    }
    public void stop_Wheel_Actuator(){
        wheelActuatorMotor.set(0);
    }
